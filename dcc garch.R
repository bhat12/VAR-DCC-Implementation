...
par(mfrow=c(3,2))
plot(as.xts(cor.s[1,2,]),main="Brent and Gold")
plot(as.xts(cor.s[1,3,]),main="Brent and Exchange rate")
plot(as.xts(cor.s[1,4,]),main="Brent and Sensex")
plot(as.xts(cor.s[2,3,]),main="Gold and Exchange rate")
plot(as.xts(cor.s[2,4,]),main="Gold and Sensex")
plot(as.xts(cor.s[3,4,]),main="Exchange rate and Sensex")
...
par(mfrow=c(3,2))
plot(as.xts(cor.exp[1,2,]),main="Brent and Gold")
plot(as.xts(cor.exp[1,3,]),main="Brent and Exchange rate")
plot(as.xts(cor.exp[1,4,]),main="Brent and Sensex")
plot(as.xts(cor.exp[2,3,]),main="Gold and Exchange rate")
plot(as.xts(cor.exp[2,4,]),main="Gold and Sensex")
plot(as.xts(cor.exp[3,4,]),main="Exchange rate and Sensex")
...
par(mfrow=c(3,2))
plot(as.xts(cor.t[1,2,]),main="Brent and Gold")
plot(as.xts(cor.t[1,3,]),main="Brent and Exchange rate")
plot(as.xts(cor.t[1,4,]),main="Brent and Sensex")
plot(as.xts(cor.t[2,3,]),main="Gold and Exchange rate")
plot(as.xts(cor.t[2,4,]),main="Gold and Sensex")
plot(as.xts(cor.t[3,4,]),main="Exchange rate and Sensex")
